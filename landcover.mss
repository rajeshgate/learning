...
@forest: #a0cf85;
@grass: #e1ebb0; // also meadow, common, garden, village_green, conservation
@golf_course: #b5e3b5;
@park: #c8df9f; // also recreation_ground
@wood: #b0c89f;
@vineyard: #b3e2a8;
@grassland: #e1ebb0;
...
@cemetery: #d5dcc2; // also grave_yard
@construction: #b6b592;
@danger_area: pink;
@desert: #e3b57a;
@field: @farmland;
...
@sand: #f7ecd2;
@school: #f2eab8; // also university, college, hospital, kindergarten
@scrub: #b5e3b5;
@orchard: #9ed88f;
@theme_park: #734a08;
@quarry: #c5c3c3;
